...
public class AppPreference {
    ...
    public static String getInterval(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                                .getString(Constants.KEY_PREF_INTERVAL_NOTIFICATION, "1"); // 60
    }
    ...
    public static String[] getCityAndCode(Context context) {
        ...
        result[0] = preferences.getString(Constants.APP_SETTINGS_CITY, "Moscow");
        result[1] = preferences.getString(Constants.APP_SETTINGS_COUNTRY_CODE, "Russian Federation");
        return result;
    }
