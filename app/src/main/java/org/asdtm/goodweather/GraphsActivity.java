...
public class GraphsActivity extends BaseActivity {
    ...
    private ProgressBar mGetWeatherProgress;
    ...
    private void setTemperatureChart() {
        ...
        if (mTemperatureChart.getData() != null) {
            ...
            try {
                ...
                Toast.makeText(this,R.string.toast_parse_error,Toast.LENGTH_LONG).show();
            }
        } else {
            set = new LineDataSet(entries, "Day");
            set.setMode(LineDataSet.Mode.CUBIC_BEZIER);
    ...
    private void setVisibleUpdating(boolean visible) {
        if (visible) {
            mGetWeatherProgress.setVisibility(ProgressBar.VISIBLE);
        } else {
            mGetWeatherProgress.setVisibility(ProgressBar.INVISIBLE);
        }
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (connection.getResponseCode() == HttpsURLConnection.HTTP_OK) {
                        ...
                        Log.d("RRRR","Graphs weather!!!"+requestResult);
